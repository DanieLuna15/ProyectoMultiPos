...
<body class="lockscreen">
  ...
  <div class="lockscreen-wrapper">
    <h4 class="text-center text-green">Punto de Venta <!--<small class="text-muted">v<?php echo settings('version');?></small>--></h4>
    <br>
    ...
    <div class="text-center">
      <a href="index.php" style="font-size:1.8rem;color:green;text-decoration:underline;"><small>O</small> accede como un usuario diferente</a>
    </div>
    <div class="lockscreen-footer text-center">
      <div class="copyright" style="font-size:1.2rem;">Copyright © <?php echo date('Y'); ?> <a href="">IMDICORP S.R.L. </a></div>
    </div>
  </div>
